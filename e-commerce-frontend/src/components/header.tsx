      ...
      <div className=" max-w-[1190px] mx-auto p-4">
        <div className="flex items-center gap-2">
          ...
          <div className="top-title flex items-center gap-4 ">
            <h5 className="text-3xl font-bold">UNITED DEALS</h5>
            <img
              src={HeaderImage}
              alt="flash sale"
              className="w-6 h-4 md:w-8 md:h-8 lg:w-10 lg:h-10 object-contain flex-shrink-0"
            />
          </div>
          ...
          <div className="deals flex align-center gap-2">
            <div className="img-deals flex align-center gap-2">
              <img src={Deals} className="w-2 h-2 md:w-5 md:h-5 lg:w-6 lg:h-6 object-contain flex-shrink-0" />
              <span className="text-base font-bold text-[#FC7901]">My Deals</span>
              <span className="mx-2">|</span>
            </div>

            <div className="sign-up-deals">
              <span className="text-base">Sign Up / Sign In</span>
              <span className="mx-2">|</span>
            </div>
