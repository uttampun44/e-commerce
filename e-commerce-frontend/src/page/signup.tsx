                    ...
                    <div className="login-form w-full md:w-1/2">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="mb-4">
                                ...
                                <input type="text" className="w-full p-3 border rounded-md bg-slate-300" placeholder="Enter your full name" {...register("fullname", { required: true })} />
                            ...
                            <div className="mb-4">
                                ...
                                <input type="email" className="w-full p-3 border rounded-md bg-slate-300" placeholder="Enter your email address" {...register("email", { required: true })} />
                            ...
                            <div className="mb-4 relative">
                                ...
                                <input type={passwordVisible ? "text" : "password"} className="w-full p-3 border rounded-md bg-slate-300" placeholder="Enter your password" {...register("password", { required: true })} />
                            ...
                            <div className="mb-4 relative">
                                ...
                                <input type="password" className="w-full p-3 border rounded-md bg-slate-300" placeholder="Enter your Confirm Password" {...register("confirm_password", { required: true })} />
                                {
